...
|---|---|---|---|
| DET-001 | Repeated failed Windows logons for one account | T1110.001 Password Guessing | [Detection.md](Detection%20SpecificationsDET-001-Repeated-Failed-Logons/Detection.md) |
