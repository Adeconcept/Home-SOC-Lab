...
```markdown
![Process creation event](screenshots/case-003-01-process-creation.png)

*Figure 1. Sysmon process creation event showing the application responsible for subsequent endpoint activity.*

---

![DNS activity](screenshots/case-003-02-dns-events.png)

*Figure 2. DNS query generated by the investigated process during the documented laboratory activity.*

---

![Network connection timeline](screenshots/case-003-03-network-connections.png)

*Figure 3. Correlated process creation, DNS resolution, and outbound network activity reconstructed into a chronological investigation timeline.*
```
